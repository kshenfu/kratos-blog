...
type ArticleRepo interface {
	// db
	ListArticle(ctx context.Context, req *pb.ListArticleRequest) ([]*Article, error)
...
func (uc *ArticleUsecase) List(ctx context.Context, req *pb.ListArticleRequest) (ps []*Article, err error) {
	ps, err = uc.repo.ListArticle(ctx, req)
	if err != nil {
		return
	}
	return
